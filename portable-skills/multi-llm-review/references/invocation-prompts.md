...
Copy one of these into any harness chat to run the skill correctly.
...
Run (replace <you> with your own name — codex, claude, antigravity/agy, or other):
  git diff HEAD | node "C:\Users\marro\.agents\skills\multi-llm-review\scripts\multi-review.mjs" --governor <you> --pretty
...
```bash
# Staged changes
git diff --cached | node "C:\Users\marro\.agents\skills\multi-llm-review\scripts\multi-review.mjs" --governor codex --pretty

# Arbitrary patch file
node "C:\Users\marro\.agents\skills\multi-llm-review\scripts\multi-review.mjs" --governor agy --input path\to\patch.diff --pretty
```
